...
#include <monolithic_pr2_planner/StateReps/ContBaseState.h> //fahad
#include <monolithic_pr2_planner/StateReps/RobotState.h>
#define X_MIN 0
#define X_MAX 15.6
#define Y_MIN 0
...
class StartGoalGenerator {
    public:
        ...
        monolithic_pr2_planner::RobotState generateRandomState(Region* region, ContBaseState base, DiscObjectState object);
        bool generateRandomValidState(monolithic_pr2_planner::RobotState& robot_state, ContBaseState base, DiscObjectState object,
                                      int region_id=-1, bool is_start_state =
                                      false);
