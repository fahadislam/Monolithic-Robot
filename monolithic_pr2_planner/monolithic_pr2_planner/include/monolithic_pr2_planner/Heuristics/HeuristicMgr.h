...
namespace monolithic_pr2_planner {
    ...
    class HeuristicMgr : public OccupancyGridUser {
        public:
            ...
            void update2DHeuristicMaps(const std::vector<unsigned char>& data); //mike
            ...
            bool getGoalSample(RobotPosePtr &sample);   //fahad
        ...
        private:
            ...
            bool getGoalPose(int g_x, int g_y, RobotPosePtr& final_pose);   //fahad
            ...
            std::vector<unsigned char> m_grid_data; //mike

            CSpaceMgrPtr m_cspace_mgr;
            std::vector<RobotPosePtr> validSamples;
    };
