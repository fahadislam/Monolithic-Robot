...
void BFS2DHeuristic::update2DHeuristicMap(const std::vector<unsigned char>& data){  //mike
    loadMap(data);
}

void BFS2DHeuristic::loadMap(const std::vector<unsigned char>& data){   //mikw
...
void BFS2DHeuristic::setGoal(GoalState& goal_state){
    ...
    m_gridsearch->search(m_grid, costmap_2d::INSCRIBED_INFLATED_OBSTACLE, state.x(), state.y(),     //mike
