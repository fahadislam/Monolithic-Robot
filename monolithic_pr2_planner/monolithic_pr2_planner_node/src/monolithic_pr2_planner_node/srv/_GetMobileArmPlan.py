...
class GetMobileArmPlanRequest(genpy.Message):
  _md5sum = "678990028373baa14adc6c690d46ac3d"
...
"""
  __slots__ = ['start','underspecified_start','planning_mode','allocated_planning_time','rarm_start','larm_start','body_start','rarm_goal','larm_goal','body_goal','goal','xyz_tolerance','roll_tolerance','pitch_tolerance','yaw_tolerance','rarm_object','larm_object','initial_eps','final_eps','dec_eps','planner_type','meta_search_type','use_ompl']
  _slot_types = ['geometry_msgs/PoseStamped','bool','int8','float64','float64[]','float64[]','float64[]','float64[]','float64[]','float64[]','geometry_msgs/PoseStamped','float64','float64','float64','float64','geometry_msgs/PoseStamped','geometry_msgs/PoseStamped','float64','float64','float64','int8','int8','bool']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       start,underspecified_start,planning_mode,allocated_planning_time,rarm_start,larm_start,body_start,rarm_goal,larm_goal,body_goal,goal,xyz_tolerance,roll_tolerance,pitch_tolerance,yaw_tolerance,rarm_object,larm_object,initial_eps,final_eps,dec_eps,planner_type,meta_search_type,use_ompl
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_10d2bB.pack(_x.larm_object.pose.position.x, _x.larm_object.pose.position.y, _x.larm_object.pose.position.z, _x.larm_object.pose.orientation.x, _x.larm_object.pose.orientation.y, _x.larm_object.pose.orientation.z, _x.larm_object.pose.orientation.w, _x.initial_eps, _x.final_eps, _x.dec_eps, _x.planner_type, _x.meta_search_type, _x.use_ompl))
...
_struct_10d2bB = struct.Struct("<10d2bB")
...
class GetMobileArmPlan(object):
  ...
  _md5sum = 'ca80c20ca7a1caf76ab297b863eb4514'
