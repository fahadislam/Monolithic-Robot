...
left_arm_start = {0.06024, 1.248526, 1.789070, -1.683386, -1.7343417, -0.0962141, -0.0864407};
// right_arm_start = {-0.023593, 1.1072800, -1.5566882, -2.124408, -1.4175, -1.8417, 0.21436};
...
// roll
    ...
    srv.request.underspecified_start = false;
    ...
    srv.request.xyz_tolerance = .0;
    srv.request.roll_tolerance = .0;
    srv.request.pitch_tolerance = .0;
    srv.request.yaw_tolerance = .0;
